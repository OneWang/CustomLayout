...
- (void)viewDidLoad {
    ...
    CGRect rect = CGRectMake(0, 50, k_Screen_width,300);
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    if ([_collectionView.collectionViewLayout isKindOfClass:[StackLayout class]]) {
        [_collectionView setCollectionViewLayout:[[LineLayout alloc] init] animated:YES];
    }else if ([_collectionView.collectionViewLayout isKindOfClass:[LineLayout class]]){
        [_collectionView setCollectionViewLayout:[[CircleLayout alloc] init] animated:YES];
    }else{
        [_collectionView setCollectionViewLayout:[[StackLayout alloc] init] animated:YES];
    }
}
